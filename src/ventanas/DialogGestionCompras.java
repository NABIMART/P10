//GESTION DE COMPRAS 
/**
 * @author Silvia Elizabeth Martinez
 * 
 */
...
public class DialogGestionCompras extends JDialog {
    ...
    public DialogGestionCompras() {
        ...
        panel.setBorder(new TitledBorder(null, "Datos de la Compra", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        JLabel lblNewLabel_4 = new JLabel("NOMBRE DEL ARTICULO");
        lblNewLabel_4.setBounds(10, 68, 112, 14);
        panel.add(lblNewLabel_4);

        JLabel lblNewLabel_5 = new JLabel("DESCRPCION");
        ...
        panel_1.setBorder(new TitledBorder(null, "Listado de Compras", TitledBorder.LEADING, TitledBorder.TOP, null, null));
