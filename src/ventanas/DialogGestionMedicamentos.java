...
public class DialogGestionMedicamentos extends JDialog {
	...
	public DialogGestionMedicamentos() {
		...
		JLabel lblNewLabel_3 = new JLabel("Codigo-Medicamento");
		...
		JLabel lblNewLabel_5 = new JLabel("Medicamento Tipo");
		...
		panel_1.setBorder(new TitledBorder(null, "Listado de Medicamentos", TitledBorder.LEADING, TitledBorder.TOP, null, null));
